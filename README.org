...
* Nix Package Reference (DO NOT TANGLE)
:PROPERTIES:
:header-args: :tangle no
:END:

This section is a reference for your =home-manager= or NixOS module.
It does *not* tangle — copy the package list into your Nix config manually.

#+begin_src nix :tangle no
# Emacs packages to install via Nix (emacsPackagesFor or home-manager)
# Keep in sync with use-package declarations above.
epkgs: with epkgs; [
  # Completion
  vertico
  orderless
