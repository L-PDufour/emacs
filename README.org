...
#+begin_src emacs-lisp
  (use-package embark
    ...
    :bind (("C-." . embark-act)
           ("M-." . embark-dwim))
    :config
    ;; Ignore Flymake diagnostics as an embark-dwim target so M-. always
    ;; falls through to eglot's identifier-based navigation.
    (setq embark-target-finders
          (remove 'embark-target-flymake-at-point embark-target-finders)))
