(message "EMACSLOADPATH: %s" (getenv "EMACSLOADPATH"))
(message "load-path: %s" load-path)
(message "Listing contents of site-lisp directories:")
(dolist (dir (split-string (getenv "EMACSLOADPATH") ":"))
  (when (file-exists-p dir)
    (message "Contents of %s:" dir)
...
;; Optional: Enable rpgtk-mode for specific file types

(add-to-list 'load-path (expand-file-name "rpgtk" (getenv "EMACSLOADPATH")))
(require 'rpgtk-mode nil t)  ; The 't' argument makes it not throw an error if not found
